...
public class AddTest {
    ...
    @Test(testName = "AddTest double",
        dataProvider = "double")
    public void addTestDouble(double first, double second){
        Assert.assertEquals(calculator.sum(first, second), first+second);
    }

    @Test(testName = "AddTest long",
            dataProvider = "long")
    public void addTestLong(long first, long second){
        Assert.assertEquals(calculator.sum(first, second), first+second);
    }
}
